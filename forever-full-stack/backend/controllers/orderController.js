...
const sendEmailWithAttachment = async (recipientEmail, pdfPath) => {
...
const sendEmailWithOrderInvoice = async (req, res) => {
...
const userOrders = async (req, res) => {
  try {
    ...
    // console.log(orders[0].items, "orders here");
